...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest testRequestConsultation = consultationController.assignForConsultation(testRequest.requestId);
        assertThat(testRequest.requestId, equalTo(testRequestConsultation.requestId));
        assertThat(testRequestConsultation.getStatus(),equalTo(RequestStatus.DIAGNOSIS_IN_PROCESS));
        assertNotNull(testRequestConsultation.consultation);
        testRequestConsultation.getConsultation();
