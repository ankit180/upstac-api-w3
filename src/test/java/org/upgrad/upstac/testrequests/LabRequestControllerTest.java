...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest testRequestAssign = labRequestController.assignForLabTest(testRequest.requestId);

        //Use assertThat() methods to perform the following two comparisons
        //  1. the request ids of both the objects created should be same
        //  2. the status of the second object should be equal to 'INITIATED'
        assertThat(testRequest.requestId, equalTo(testRequestAssign.requestId));
        assertThat(testRequestAssign.getStatus(),equalTo(RequestStatus.INITIATED));
        ...
        assertNotNull(testRequestAssign.getLabResult());
        testRequest.getLabResult();
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_throw_exception(){
        ...
        assertThat(responseStatusException.getMessage(), is("400 BAD_REQUEST \"Invalid ID\""));
    ...
    public void calling_updateLabTest_with_valid_test_request_id_should_update_the_request_status_and_update_test_request_details(){
        ...
        TestRequest testRequestStatus = labRequestController.updateLabTest(testRequest.requestId, labResult);
        ...
        assertThat(testRequest.requestId, equalTo(testRequestStatus.requestId));
        assertThat(testRequestStatus.getStatus(),equalTo(RequestStatus.LAB_TEST_COMPLETED));
        assertThat(testRequest.getLabResult(), equalTo(testRequestStatus.getLabResult()));
    ...
    public void calling_updateLabTest_with_invalid_empty_status_should_throw_exception(){
        ...
        assertThat(responseStatusException.getMessage(), is("ConstraintViolationException"));
